...
#### John:
John created the RecurrenceEquationBuilder class, which constructs a system of linear equations based on the provided DFA.

#### Angelica: 
Angelica developed the RecurrenceEquationSolver class, which solves the system of linear equations generated by the RecurrenceEquationBuilder to find the probabilities of winning.
